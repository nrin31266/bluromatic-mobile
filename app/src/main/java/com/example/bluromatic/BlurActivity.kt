...
fun Context.getImageUri(): Uri {
    ...
    return Uri.Builder()
        ...
        .authority(resources.getResourcePackageName(R.drawable.anime))
        .appendPath(resources.getResourceTypeName(R.drawable.anime))
        .appendPath(resources.getResourceEntryName(R.drawable.anime))
        .build()
}
